<html>
    ...
    <body>
        <div style="width:190mm">
            ...
            <h1 align="center"></h1>
            <?php 
                if (@$obj->email != '' ||  @$obj->mobile || @$obj->name != ''){
            ?>
            <table border="0">
                <tr>
                    <th width="100px">Name:</th><td>{{ @$obj->name }}</td>
                </tr>
                <tr>
                    <th width="100px">Email:</th><td>{{ @$obj->email }}</td>
                </tr>
                <tr>
                    <th width="100px">Mobile:</th><td>{{ @$obj->mobile }}</td>
                </tr>
            </table>
            <?php } ?>
            ...
            <table>
                ...
                foreach ($g as $key => $v) {
                    print("<td width='20%'".(in_array($v, $i)? "class='Yes'": "class='No'").">" . $v . "</td>");
                }
            ?>
                </tr>
            </table>
